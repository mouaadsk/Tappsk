...
import 'package:tappsk_to_do_list_habit_tracker_and_reminder/Widgets/Circle%20Task%20Widgets/circleTasksList.dart';
import 'package:tappsk_to_do_list_habit_tracker_and_reminder/Widgets/customAnimatedPositioned.dart';
import 'package:tappsk_to_do_list_habit_tracker_and_reminder/Widgets/SimpleTask%20Widgets/simpleTaskEditingPage.dart';
import 'package:tappsk_to_do_list_habit_tracker_and_reminder/Widgets/SimpleTask%20Widgets/tasksTileList.dart';
        ...
        child: SafeArea(
          child: Expanded(
            child: BlocProvider(
                ...
                child: BlocProvider<SimpletaskeditBloc>(
                  create: (context) => SimpletaskeditBloc(),
                  child: Stack(
                    children: [
                      ScrollConfiguration(
                                    ...
                                    simpletaskBloc.add(
                                      StartAnimation(
                                          animationController: this
                                              .simpleTaskAnimationController,
                                          simpleTask: SimpleTask()),
                                    );
                                    context
                                        .bloc<SimpletaskeditBloc>()
                                        .add(CreateNewTask());
                                  },
                                  elevation: 2.0,
